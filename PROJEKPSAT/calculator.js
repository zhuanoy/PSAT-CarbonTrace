...
// FIX BUG #3: Bind label frekuensiPesawat (input type number)
const pesawatInput = document.getElementById('frekuensiPesawat');
const pesawatLabel = document.getElementById('frekuensiPesawatValue');
if (pesawatInput && pesawatLabel) {
    const updatePesawat = () => { pesawatLabel.innerText = pesawatInput.value; };
    pesawatInput.addEventListener('input', updatePesawat);
    updatePesawat();
}
...
// FIX BUG #1 & #2: Gunakan event delegation agar tidak crash saat load
...
function hitungJejakKarbon() {
    ...
    // FIX: ambil resultsDiv secara lokal
    document.getElementById('results').style.display = 'block';
}
 
// FIX BUG #1 & #2: Fungsi reset dipisah agar bisa dipanggil dari event delegation
